...
class TrueLicensePluginGrailsPlugin {
    ...
    def title = "This plugin provides license management to Grails application."
    def description = '''\
     This plugin utilizes TrueLicense Library Collection(TLC) to securely create, install and verify license
